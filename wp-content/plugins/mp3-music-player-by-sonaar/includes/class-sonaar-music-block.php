...
class Sonaar_Block {
    ...
    function sonaar_block_editor_scripts() {
		...
		wp_register_script( 'sonaar-music-mp3player', plugin_dir_url( dirname( __FILE__ ) ) . 'public/js/iron-audioplayer/iron-audioplayer.js', array( 'jquery', 'sonaar-music' ,'moments', 'wave'), $this->version, true );
		...
		wp_enqueue_style( 'select2-css', plugin_dir_url( dirname( __FILE__ ) ) . 'admin/css/select2.min.css' );
		wp_enqueue_script( 'select2-js', plugin_dir_url( __DIR__ ) . 'admin/js/select2.min.js','4.1.0', true );
    ...
    function render_sonaar_block( $attributes ) {
		...
		$filter_container_bg = '';
		$filter_border_style = 'none';
		$filter_border_width = 1;
		$filter_border_color = '#000000';
		$filter_border_radius = 0;
		...
		if ( function_exists( 'run_sonaar_music_pro' ) ){
			...
			$disable_searchbar_keyword = ( isset( $attributes['disable_searchbar_keyword'] ) && !$attributes['disable_searchbar_keyword'] && isset( $attributes['show_searchbar'] ) && $attributes['show_searchbar'] ) ? true : false;
			$disable_filters = ( isset( $attributes['disable_filters'] ) && !$attributes['disable_filters'] && isset( $attributes['show_searchbar'] ) && $attributes['show_searchbar'] ) ? true : false;
			$show_duration_filter = ( isset( $attributes['show_duration_filter'] ) && $attributes['show_duration_filter'] && $disable_filters) ? true : false;
			$show_date_filter = ( isset( $attributes['show_date_filter'] ) && $attributes['show_date_filter'] && $disable_filters) ? true : false;
			$show_name_filter = ( isset( $attributes['show_name_filter'] ) && $attributes['show_name_filter'] && $disable_filters) ? true : false;
			...
			$filter_color = ( isset( $attributes['filter_color'] ) && $attributes['filter_color'] ) ? $attributes['filter_color'] : '';
			$filter_hover_color = ( isset( $attributes['filter_hover_color'] ) && $attributes['filter_hover_color'] ) ? $attributes['filter_hover_color'] : '';
			$filter_bg_color = ( isset( $attributes['filter_bg_color'] ) && $attributes['filter_bg_color'] ) ? $attributes['filter_bg_color'] : '';
			$filter_hover_bg_color = ( isset( $attributes['filter_hover_bg_color'] ) && $attributes['filter_hover_bg_color'] ) ? $attributes['filter_hover_bg_color'] : '';
			$search_fontsize = ( isset( $attributes['search_fontsize'] ) && $attributes['search_fontsize'] ) ? $attributes['search_fontsize'] : 0;
			$filter_fontsize = ( isset( $attributes['filter_fontsize'] ) && $attributes['filter_fontsize'] ) ? $attributes['filter_fontsize'] : 0;
			...
			$filter_container_padding = ( isset( $attributes['filter_container_padding'] ) && $attributes['filter_container_padding'] ) ? $attributes['filter_container_padding'] : 0;
			...
			$filter_hover_border_color = ( isset( $attributes['filter_hover_border_color'] ) && $attributes['filter_hover_border_color'] ) ? $attributes['filter_hover_border_color'] : '';
			$filter_container_bg = ( isset( $attributes['filter_container_bg'] ) && $attributes['filter_container_bg'] ) ? $attributes['filter_container_bg'] : '';
			$filter_border_style = ( isset( $attributes['filter_border_style'] ) && $attributes['filter_border_style'] ) ? $attributes['filter_border_style'] : '';
			$filter_border_width = ( isset( $attributes['filter_border_width'] ) && $attributes['filter_border_width'] ) ? $attributes['filter_border_width'] : 1;
			$filter_border_color = ( isset( $attributes['filter_border_color'] ) && $attributes['filter_border_color'] ) ? $attributes['filter_border_color'] : '#000000';
			$filter_border_radius = ( isset( $attributes['filter_border_radius'] ) && $attributes['filter_border_radius'] ) ? $attributes['filter_border_radius'] : 0;
		...
		if( function_exists( 'run_sonaar_music_pro' ) ) { 
			...
			$custom_css .= ' #'.$block_id .' .srp_search_main { padding: '.$filter_container_padding.'px;}';
			...
			//$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button { border-style: '.$filter_border_style.'; }';		
			...
			/*if( $filter_border_style != 'none' ) {
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button { border-width: '.$filter_border_width.'px; }';
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button { border-color: '.$filter_border_color.'; }';
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button { border-radius: '.$filter_border_radius.'px; }';
			}*/
			...
			if( $tracklist_bg != '' ) {
				if($player_layout == 'skin_boxed_tracklist'){
					...
					$custom_css .= ' #'.$block_id .' .iron-audioplayer[data-playertemplate="skin_float_tracklist"] .sonaar-grid{ background: '.$tracklist_bg.'; }';
				} 
			}
			...
			/*if( $filter_color != '' ) {
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button { color: '.$filter_color.'; }';
			}

			if( $filter_hover_color != '' ) {
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button:hover { color: '.$filter_hover_color.'; }';
			}

			if( $filter_bg_color != '' ) {
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button { background: '.$filter_bg_color.'; }';
			}

			if( $filter_hover_bg_color != '' ) {
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button:hover { background: '.$filter_hover_bg_color.'; }';
			}*/
			...
			/*if( $filter_fontsize > 0 ) {
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button { font-size: '.$filter_fontsize.'px; }';
			}*/
			...
			/*if( $filter_hover_border_color != '' && $filter_border_style != 'none' ) {
				$custom_css .= ' #'.$block_id .' .iron-audioplayer .srp_filter .srp_sort_button button:hover { border-color: '.$filter_hover_border_color.' !important; }';
			}*/
			if( $filter_container_bg != '' ) {
				$custom_css .= ' #'.$block_id .' .srp_search_main { background: '.$filter_container_bg.'; }';
			}
	...
	private function sr_plugin_block_attribute() {
		...
		$attributes = array(
			...
			'disable_searchbar_keyword' => array(
				'type'    => 'boolean',
				'default' => false,
			),
			...
			$attributes['filter_color'] = array(
				'type'    => 'string',
				'default' => '',
			);
			$attributes['filter_hover_color'] = array(
				'type'    => 'string',
				'default' => '',
			);
			$attributes['filter_bg_color'] = array(
				'type'    => 'string',
				'default' => '',
			);
			$attributes['filter_hover_bg_color'] = array(
				'type'    => 'string',
				'default' => '',
			);
			...
			$attributes['filter_fontsize'] = array(
                'type' => 'integer',
                'default' => 0,
			);
            ...
            $attributes['filter_container_padding'] = array(
                'type' => 'integer',
                'default' => 0,
			);
			...
			$attributes['filter_hover_border_color'] = array(
				'type'    => 'string',
				'default' => '',
			);	
			$attributes['filter_container_bg'] = array(
				'type'    => 'string',
				'default' => '',
			);						
			$attributes['filter_border_style'] = array(
				'type'    => 'string',
				'default' => 'none',
			);
			$attributes['filter_border_width'] = array(
				'type'    => 'integer',
				'default' => 1,
			);			
			$attributes['filter_border_color'] = array(
				'type'    => 'string',
				'default' => 'black',
			);
			$attributes['filter_border_radius'] = array(
				'type'    => 'integer',
				'default' => 0,
			);
