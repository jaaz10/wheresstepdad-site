...
Tags: MP3, audio player, HTML5 mp3 player, HTML5 audio player, audioplayer, elementor, podcast, audio, woocommerce, music player, beat, music store, gutenberg
...
Our MP3 player is the best plugin for WordPress to add music, loops and drumkits, to your website.
    ...
    ✔ Sticky Player is also available with Pro.
...
Don't look further Podcasters! This is the ultimate podcast plugin for WordPress ever created. It has all the features required to design the next-level Podcast Website.
	✔ Create unlimited, highly customizable podcast players
    ✔ Import any podcasts from all major podcast distributors in 1-click
    ✔ Subscribe Buttons, Show Notes, Automatic RSS Feed Update, and Continuous Sticky Player available with Pro.
...
[Live demo of a BEATSTORE/WooCommerce](https://templates.sonaar.io/rebirth/?utm_source=Sonaar+Music+Free+Plugin&utm_medium=plugin)
...
* Support MP3, audio streaming, radio streaming and all major podcast distributors
* Upload audio tracks from any posts, custom posts or pages
* Import Podcast Episodes and Podcast Show from any podcast distributor in 1-click and presto ... you are ready to go! (NEW!)
...
* [NEW!] Full Lyrics and Karaoke Support. Create Karaoke Player or audio lyrics to your site by using Timed Text Markup Language (TTML).
...
* [NEW!] Pagination option to paginate your tracklist
...
2. Podcast Player with episode list
3. Podcast Mini Player
4. Unlimited Look and feel possibilities
5. MP3 player with Waveform
6. Sell Music Online. Support for WooCommerce.
7. Infinite Options to customize your music player
8. Elementor Widget Available
9. Custom Fields to upload or stream tracks
10. Playlist Post Type CPT
11. Playlist Statistic with Pro
12. General Settings Dashboard
