...
$redirect     = (isset($terms_data['srpodcast_redirect_feed'])) ? $terms_data['srpodcast_redirect_feed'][0] : '';
$new_feed_url = false;

if ( $redirect && $redirect == 'true' ) {
	$new_feed_url = $terms_data['srpodcast_new_feed_url'][0];
