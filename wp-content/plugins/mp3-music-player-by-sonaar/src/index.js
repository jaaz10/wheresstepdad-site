    ...
    registerBlockType('sonaar/sonaar-block', {
        ...
        edit(props) {
            ...
            function style_changes() {
               ...
               // custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button { border-style: ' + filter_border_style + '; }';
            ...
            return [
                createElement(InspectorControls, {
                    ...
                    show_searchbar && createElement(PanelBody, {
                      ...
                      !disable_searchbar_keyword && createElement('hr', {}),
                    ...
                    !disable_searchbar_keyword && createElement(RangeControl, {
                      ...
                      !disable_filters && createElement('hr', {}),
                      ...
                      !disable_filters && createElement(RangeControl, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_fontsize: value });
                            style_changes();
                        }
                    }),
                    ...
                    !disable_filters && createElement(ColorPalette, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_color: value });
                            style_changes();
                        }
                    }),
                    !disable_filters && createElement(RichText.Content, {
                    ...
                    !disable_filters && createElement(ColorPalette, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_hover_color: value });
                            style_changes();
                        }
                    }),
                    !disable_filters && createElement(RichText.Content, {
                    ...
                    !disable_filters && createElement(ColorPalette, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_bg_color: value });
                            style_changes();
                        }
                    }),
                    !disable_filters && createElement(RichText.Content, {
                    ...
                    !disable_filters && createElement(ColorPalette, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_hover_bg_color: value });
                            style_changes();
                        }
                    }),
                    ...
                    createElement(SelectControl, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_border_style: value });
                    ...
                    (filter_border_style != 'none') && createElement(RangeControl, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_border_width: value });
                    ...
                    (filter_border_style != 'none') && createElement(ColorPalette, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_border_color: value });
                            style_changes();
                        }
                    }),
                    ...
                    (filter_border_style != 'none') && createElement(ColorPalette, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_hover_border_color: value });
                            style_changes();
                        }
                    }),
                    (filter_border_style != 'none') && createElement(RangeControl, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_border_radius: value });
                    ...
                    createElement(ColorPalette, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_container_bg: value });
                            style_changes();
                        }
                    }),
                    createElement(RangeControl, {
                        ...
                        onChange: value => {
                            ...
                            is_style_loaded;
                            setAttributes({ filter_container_padding: value });
                            style_changes();
                        }
                    }),
