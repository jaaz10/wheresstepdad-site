...
(function (wp) {
  ...
  registerBlockType('sonaar/sonaar-block', {
    ...
    edit: function edit(props) {
      ...
      var disable_filters = true;
      var show_duration_filter = true;
      var show_date_filter = true;
      var show_name_filter = true;
      var disable_searchbar_keyword = true;
      ...
      var filter_color = '';
      var filter_hover_color = '';
      var filter_bg_color = '';
      var filter_hover_bg_color = '';
      var search_fontsize = '';
      var filter_fontsize = '';
      var tracklist_bg = '';
      var player_bg = '';
      ...
      var filter_container_padding = 0;
      ...
      var filter_border_style = 'none';
      var filter_border_width = 1;
      var filter_border_color = 'black';
      var filter_border_radius = 0;
      var filter_hover_border_color = '';
      var filter_container_bg = '';
      ...
      if (run_pro) {
        ...
        disable_filters = attributes.disable_filters;
        show_duration_filter = attributes.show_duration_filter;
        show_date_filter = attributes.show_date_filter;
        show_name_filter = attributes.show_name_filter;
        disable_searchbar_keyword = attributes.disable_searchbar_keyword;
        ...
        filter_color = attributes.filter_color;
        filter_hover_color = attributes.filter_hover_color;
        filter_bg_color = attributes.filter_bg_color;
        filter_hover_bg_color = attributes.filter_hover_bg_color;
        search_fontsize = attributes.search_fontsize;
        filter_fontsize = attributes.filter_fontsize;
        ...
        filter_container_padding = attributes.filter_container_padding;
        ...
        filter_hover_border_color = attributes.filter_hover_border_color;
        filter_container_bg = attributes.filter_container_bg;
        ...
        filter_border_style = attributes.filter_border_style;
        filter_border_width = attributes.filter_border_width;
        filter_border_color = attributes.filter_border_color;
      ...
      var SrpModalGoPro = function SrpModalGoPro() {
        return createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, isOpen && createElement(Modal, {
          ...
          href: "https://sonaar.io/mp3-audio-player-pro/pricing/?utm_source=Sonaar+Music+Free+Plugin&utm_medium=plugin#pricing",
          target: "_blank",
          isPrimary: true
        }, "Learn More")));
      };
      ...
      function style_changes() {
        ...
        custom_css += ' #block-' + clientId + ' div.srp_search_main { padding: ' + filter_container_padding + 'px;}';
        ...
        custom_css += ' #block-' + clientId + ' .iron-audioplayer .buttons-block .store-list li .button { border-style: ' + button_border_style + '; }'; // custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button { border-style: ' + filter_border_style + '; }';
        ...
        /*if (filter_border_style != 'none') {
            custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button { border-width: ' + filter_border_width + 'px; }';
            custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button { border-color: ' + filter_border_color + '; }';
            custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button { border-radius: ' + filter_border_radius + 'px; }';
        }*/
        ...
        /*if (filter_color != '') {
            custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button{ color: ' + filter_color + '; }';
        }
        if (filter_hover_color != '') {
            custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button:hover { color: ' + filter_hover_color + '; }';
        }
        if (filter_bg_color != '') {
            custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button { background: ' + filter_bg_color + '; }';
        }
        if (filter_hover_bg_color != '') {
            custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button:hover { background: ' + filter_hover_bg_color + '; }';
        }*/


        if (search_fontsize != '') {
          custom_css += ' #block-' + clientId + ' .srp_search_container .srp_search,  #block-' + clientId + ' .srp_search_container { font-size: ' + search_fontsize + 'px; }';
        }
        /*if (filter_fontsize != '') {
            custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button { font-size: ' + filter_fontsize + 'px; }';
        }*/
        ...
        /* if (filter_hover_border_color != '' && filter_border_style != 'none') {
             custom_css += ' #block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button:hover { border-color: ' + filter_hover_border_color + ' !important; }';
         }*/


        if (filter_container_bg != '') {
          custom_css += ' #block-' + clientId + ' .srp_search_main { background: ' + filter_container_bg + '; }';
        }
        ...
        jQuery('#block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button').css('border-style', filter_border_style);
        jQuery('#block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button').css('border-width', filter_border_width + 'px');
        /* if (filter_border_color != '' && filter_border_color != undefined) {
             jQuery('#block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button').css('border-color', filter_border_color);
         } else {
             jQuery('#block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button').css('border-color', 'inherit');
         }
          jQuery('#block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button').css('border-radius', filter_border_radius + 'px');
         */
      ...
      return [createElement(InspectorControls, {
        ...
        label: __('Show Search Bar and Filters', 'sonaar-music'),
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            image_overlay_on_hover: value
          });
          style_changes();
        }
      })), show_searchbar && createElement(PanelBody, {
        title: __('Search Bar & Filters', 'sonaar-music'),
        initialOpen: false,
        className: show_pro_badge
        ...
        label: __('Disable Keyword Search', 'sonaar-music'),
        checked: disable_searchbar_keyword,
        className: show_pro_badge,
        onChange: function onChange(disable_searchbar_keyword) {
          if (!run_pro) {
            openGoProModal();
            return;
          }
          ...
          setAttributes({
            disable_searchbar_keyword: disable_searchbar_keyword
          });
          ironAudioplayersLoaded = false;
          setIronAudioplayers;
          style_load = false;
        }
      }), !disable_searchbar_keyword && createElement('hr', {}), !disable_searchbar_keyword && createElement(RichText.Content, {
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        value: __('Search Color', 'sonaar-music')
      }), !disable_searchbar_keyword && createElement(ColorPalette, {
      ...
      }), !disable_searchbar_keyword && createElement(RichText.Content, {
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            search_background: value
          });
          style_changes();
        }
      }), !disable_searchbar_keyword && createElement(RangeControl, {
        ...
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        value: __('Filter Buttons', 'sonaar-music')
      }), createElement(ToggleControl, {
        label: __('Disable Filters', 'sonaar-music'),
        checked: disable_filters,
        className: show_pro_badge,
        onChange: function onChange(disable_filters) {
          if (!run_pro) {
            openGoProModal();
            return;
          }
      ...
      }), !disable_filters && createElement('hr', {}), !disable_filters && createElement(ToggleControl, {
        label: __('Sort by Name Filter', 'sonaar-music'),
        checked: show_name_filter,
        className: show_pro_badge,
        onChange: function onChange(show_name_filter) {
          if (!run_pro) {
            openGoProModal();
            return;
          }
          ...
          setAttributes({
            show_name_filter: show_name_filter
          });
          ironAudioplayersLoaded = false;
          setIronAudioplayers;
          style_load = false;
        }
      }), !disable_filters && createElement(ToggleControl, {
        label: __('Sort by Date Filter', 'sonaar-music'),
        checked: show_date_filter,
        className: show_pro_badge,
        onChange: function onChange(show_date_filter) {
          if (!run_pro) {
            openGoProModal();
            return;
          }
        ...
        label: __('Sort by Duration Filter', 'sonaar-music'),
        checked: show_duration_filter,
        className: show_pro_badge,
        onChange: function onChange(show_duration_filter) {
          if (!run_pro) {
            openGoProModal();
            return;
          }
          ...
          setAttributes({
            show_duration_filter: show_duration_filter
          });
          ironAudioplayersLoaded = false;
          setIronAudioplayers;
          style_load = false;
        }
      }), !disable_filters && createElement(RangeControl, {
        label: __('Filter Fontsize (px)', 'sonaar-music'),
        value: filter_fontsize,
        min: 0,
        max: 100,
        onChange: function onChange(value) {
          if (!run_pro) {
          ...
          is_style_loaded;
          setAttributes({
            filter_fontsize: value
          });
          style_changes();
        }
      }), !disable_filters && createElement(RichText.Content, {
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        value: __('Filter Text Color', 'sonaar-music')
      }), !disable_filters && createElement(ColorPalette, {
        label: __('Filter Text Color', 'sonaar-music'),
        colors: colors,
        value: filter_color,
        onChange: function onChange(value) {
          if (!run_pro) {
        ...
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        value: __('Filter Text Hover Color', 'sonaar-music')
      }), !disable_filters && createElement(ColorPalette, {
        label: __('Filter Text Hover Color', 'sonaar-music'),
        colors: colors,
        value: filter_hover_color,
        onChange: function onChange(value) {
          if (!run_pro) {
            openGoProModal();
            return;
        ...
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        value: __('Filter Background Color', 'sonaar-music')
      }), !disable_filters && createElement(ColorPalette, {
        label: __('Filter Background Color', 'sonaar-music'),
        colors: colors,
        value: filter_bg_color,
        onChange: function onChange(value) {
          if (!run_pro) {
            openGoProModal();
            return;
        ...
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        value: __('Filter Hover Background Color', 'sonaar-music')
      }), !disable_filters && createElement(ColorPalette, {
        label: __('Filter Hover Background Color', 'sonaar-music'),
        colors: colors,
        value: filter_hover_bg_color,
        onChange: function onChange(value) {
          if (!run_pro) {
            openGoProModal();
            return;
          ...
          is_style_loaded;
          setAttributes({
            filter_hover_bg_color: value
          });
          style_changes();
        }
      }), createElement(SelectControl, {
        options: border_types,
        value: filter_border_style,
        onChange: function onChange(value) {
          if (!run_pro) {
            openGoProModal();
            return;
          ...
          is_style_loaded;
          setAttributes({
            filter_border_style: value
          }); // jQuery('#block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button').css('border-style', value);
        }
      }), filter_border_style != 'none' && createElement(RangeControl, {
        label: __('Button Border Width (px)', 'sonaar-music'),
        value: filter_border_width,
        min: 0,
        max: 50,
        onChange: function onChange(value) {
          if (!run_pro) {
          ...
          is_style_loaded;
          setAttributes({
            filter_border_width: value
          });
          jQuery('#block-' + clientId + ' .buttons-block .store-list li .button').css('border-width', value + 'px');
        }
      }), filter_border_style != 'none' && createElement(ColorPalette, {
        label: __('Filter Border Color', 'sonaar-music'),
        colors: colors,
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            filter_border_color: value
          });
          style_changes();
        }
      }), filter_border_style != 'none' && createElement(RichText.Content, {
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        value: __('Filter Border Hover Color', 'sonaar-music')
      }), filter_border_style != 'none' && createElement(ColorPalette, {
        label: __('Filter Border Hover Color', 'sonaar-music'),
        colors: colors,
        value: filter_hover_border_color,
        onChange: function onChange(value) {
          if (!run_pro) {
            openGoProModal();
            return;
          ...
          is_style_loaded;
          setAttributes({
            filter_hover_border_color: value
          });
          style_changes();
        }
      }), filter_border_style != 'none' && createElement(RangeControl, {
        label: __('Filter Radius (px)', 'sonaar-music'),
        value: filter_border_radius,
        min: 0,
        max: 30,
        onChange: function onChange(value) {
          if (!run_pro) {
          ...
          is_style_loaded;
          setAttributes({
            filter_border_radius: value
          }); // jQuery('#block-' + clientId + ' .iron-audioplayer .srp_filter .srp_sort_button button').css('border-radius', value + 'px');
        }
      }), createElement('hr', {}), createElement(RichText.Content, {
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        value: __('Filter Container', 'sonaar-music')
      }), createElement(RichText.Content, {
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            filter_container_bg: value
          });
          style_changes();
        }
      }), createElement(RangeControl, {
        label: __('Container Padding', 'sonaar-music'),
        value: filter_container_padding,
        min: 0,
        max: 100,
        onChange: function onChange(value) {
          if (!run_pro) {
          ...
          is_style_loaded;
          setAttributes({
            filter_container_padding: value
          });
          style_changes();
        }
      ...
      createElement('hr', {}), createElement(RichText.Content, {
        ...
        onChange: function onChange(cta_track_show_label) {
          setAttributes({
        ...
        onChange: function onChange(player_inline) {
          if (!run_pro) {
            openGoProModal();
            return;
          }
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            album_title_soundwave_fontsize: value
          });
          style_changes();
        }
        ...
        onChange: function onChange(hide_player_subheading) {
          if (!run_pro) {
            openGoProModal();
            return;
          }
          ...
          is_style_loaded;
          setAttributes({
            hide_player_subheading: hide_player_subheading
          });
          style_changes();
        }
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            player_subheading_fontsize: value
          });
          style_changes();
        }
      ...
      }), createElement('hr', {}), player_layout != 'skin_float_tracklist' && createElement(ToggleControl, {
        ...
        onChange: function onChange(value) {
          ...
          setAttributes({
            use_play_label_with_icon: value
          });
          ironAudioplayersLoaded = false;
          setIronAudioplayers;
          style_load = false;
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            audio_player_controls_color_hover: value
          });
          style_changes();
        }
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            audio_player_play_text_color: value
          });
          style_changes();
        }
      }), use_play_label && player_layout != 'skin_float_tracklist' && createElement(RichText.Content, {
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            audio_player_play_text_color_hover: value
          });
          style_changes();
        }
      }), use_play_label && player_layout != 'skin_float_tracklist' && createElement('hr', {}), use_play_label && player_layout != 'skin_float_tracklist' && createElement(RichText.Content, {
        tagName: 'label',
        className: 'components-base-control__label sonaar-block-label',
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            extended_control_btn_color: value
          });
          style_changes();
        }
      }), player_layout != 'skin_float_tracklist' && createElement(RichText.Content, {
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            extended_control_btn_color_hover: value
          });
          style_changes();
        }
      }), use_play_label && player_layout != 'skin_float_tracklist' && play_border_style != 'none' && createElement(RangeControl, {
        ...
        onChange: function onChange(value) {
          ...
          is_style_loaded;
          setAttributes({
            play_border_radius: value
          });
          style_changes();
        }
      }), use_play_label && player_layout != 'skin_float_tracklist' && createElement('hr', {}), use_play_label && player_layout != 'skin_float_tracklist' && createElement(RangeControl, {
